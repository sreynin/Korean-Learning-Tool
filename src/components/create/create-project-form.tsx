  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      <Alert tone="info" className="mb-6">
        Generating the lesson takes a moment. Every stage after it is
        connected — storyboard, voice, captions, preview, rendering, and
        YouTube. Only scene imagery is still generated by hand.
      </Alert>
